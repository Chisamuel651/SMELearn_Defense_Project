...
<body>
    ...
    <header id="nav">
       <div class="nav--list">
        ...
        <div id="nav__links">
            ...
            <a class="nav__link" href="../dashboard.php">
                Dashboard
    ...
    <main class="container">
        <div id="room__container">
            ...
            <!-- left side of the page ends here -->
            ...
            <section id="stream__container">
                ...
                <div class="stream__actions">
                    ...
                    <button id="leave-btn" style="background-color: #e5383b;">
...
<script type="text/javascript" src="js/smelearn.js"></script>
<script type="text/javascript" src="js/real-time-message.js"></script>
